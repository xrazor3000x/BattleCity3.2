...
void TanqueEnemigoF::analizar(Actor* _tanqueJugador)
{
	float x = 0.0;
	float y = 0.0;
...
void TanqueEnemigoF::moverDireccionRandom()
{
...
void TanqueEnemigoF::moverDireccionIA(Actor* _tanqueJugador) {
	Direccion direccionAnterior = getDireccion();
	Direccion direccionNueva;
...
void TanqueEnemigoF::actualizar(float _dt)
{
